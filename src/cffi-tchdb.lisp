...
;;;
;;; LOG:
;;; This file is mostly autogenerated by swig
;;; 
;;; So far I have only added #. where defanonenum is used
;;; like in:
;;; (defanonenum 
;;;	(HDBOREADER #.(cl:ash 1 0))
;;;
;;; TODO: 
;;; * Split this file in two: The defpackage part and the cffi-binding part
;;;   to make it easier to update the bindings later
