...
(cffi:defcstruct TDBIDX
	(name :string)
	(type :int)
	(db :pointer)
	(cc :pointer))

(cffi:defcstruct TCTDB
	(mmtx :pointer)
	(hdb :pointer)
	(open :pointer)
	(wmode :pointer)
...
(cffi:defctype TDBQRYPROC :pointer)
...
(cffi:defcfun ("tctdbiternext3" tctdbiternext3) :pointer
  (tdb :pointer))
...
(cffi:defcfun ("tctdbqrysetlimit" tctdbqrysetlimit) :void
  (qry :pointer)
  (max :int)
  (skip :int))
...
(cffi:defcfun ("tctdbmetasearch" tctdbmetasearch) :pointer
  (qrys :pointer)
  (num :int)
  (type :int))

(cffi:defcfun ("tctdbsetecode" tctdbsetecode) :void
  (tdb :pointer)
  (ecode :int)
  (filename :string)
  (line :int)
...
(cffi:defcfun ("tctdbsetdbgfd" tctdbsetdbgfd) :void
  (tdb :pointer)
  (fd :int))
...
(cffi:defcfun ("tctdbbnum" tctdbbnum) :pointer
  (tdb :pointer))

(cffi:defcfun ("tctdbalign" tctdbalign) :pointer
  (tdb :pointer))

(cffi:defcfun ("tctdbfbpmax" tctdbfbpmax) :pointer
  (tdb :pointer))

(cffi:defcfun ("tctdbinode" tctdbinode) :pointer
  (tdb :pointer))

(cffi:defcfun ("tctdbmtime" tctdbmtime) :pointer
  (tdb :pointer))

(cffi:defcfun ("tctdbflags" tctdbflags) :pointer
  (tdb :pointer))

(cffi:defcfun ("tctdbopts" tctdbopts) :pointer
  (tdb :pointer))

(cffi:defcfun ("tctdbopaque" tctdbopaque) :string
  (tdb :pointer))

(cffi:defcfun ("tctdbbnumused" tctdbbnumused) :pointer
  (tdb :pointer))

(cffi:defcfun ("tctdbinum" tctdbinum) :int
  (tdb :pointer))
...
(cffi:defcfun ("tctdbget4" tctdbget4) :string
  (tdb :pointer)
  (pkbuf :pointer)
  (pksiz :int)
  (nbuf :pointer)
...
(cffi:defcfun ("tctdbstrtometasearcytype" tctdbstrtometasearcytype) :int
  (str :string))

(cffi:defcfun ("tctdbqrycount" tctdbqrycount) :int
  (qry :pointer))

(cffi:defcfun ("tctdbqrykwic" tctdbqrykwic) :pointer
  (qry :pointer)
  (cols :pointer)
  (name :string)
  (width :int)
...
(cffi:defcfun ("tctdbmetastrtosettype" tctdbmetastrtosettype) :int
  (str :string))
